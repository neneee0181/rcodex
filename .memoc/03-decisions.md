...
- **2026-05-22: Integrated 9router AI providers**: Integrated 4 new AI providers (`kiro` for AWS CodeWhisperer proxying with frame decoding, `vertex` with native Google/Partner deepseek/qwen model JWT signing and token exchange, `opencode`, and `freetier` supporting 31 generic OpenAI/Claude-compatible endpoints) directly without external AWS SDK or JWT dependencies.
